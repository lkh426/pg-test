...
# 操作流程
# click_if_exists(poco(text="允許"), "允許", "沒有通知權限彈窗")
...
print("點擊帳號")
# click_if_exists(poco(text="jadeliu4"), "確認有登入帳號", "確認有登入帳號")
sleep(10.0)
...
print(f"腳本總共執行了 {total_duration:.2f} 秒")
