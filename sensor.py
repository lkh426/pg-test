...
# feishu_webhook_url = "https://open.feishu.cn/open-apis/bot/v2/hook/407dee39-3ae0-4a4b-a39f-4709a0b61ae1"#測試
...
def main():
    ...
    driver.get("http://livemesensor.ksmobile.com:8107/dashboard/?project=PG&product=sensors_analysis&id=2017&dash_type=lego")
